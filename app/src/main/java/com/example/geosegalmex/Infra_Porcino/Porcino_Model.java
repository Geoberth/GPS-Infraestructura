...
public class Porcino_Model implements Serializable {
    ...
    public Porcino_Model(String folio, String cveEntidad, String entidad, String cveRepresentacion, String representacion, String cveDdr, String ddr, String cveCader, String cader, String cveMunicipio, String municipio, String cveLocalidad, String loc, String domUpp, String nomUpp, String estatus, String sistema, String actividad, String numVientres, String numLechones, String numCrecimiento, String numFinalizacion, String numSementales, String capInst, String capUtil, String totalAnim, String raza, String razaCruza, String razaOtra, String superf, String observ, String longitud, String latitud, String f1, String f2) {
        ...
        this.numVientres = numVientres;
        this.numLechones = numLechones;
        this.numCrecimiento = numCrecimiento;
        this.numFinalizacion = numFinalizacion;
        this.numSementales = numSementales;
    ...
    public String getNumVientres() {
        return numVientres;
    }

    public void setNumVientres(String numVientres) {
        this.numVientres = numVientres;
    }

    public String getNumLechones() {
        return numLechones;
    }

    public void setNumLechones(String numLechones) {
        this.numLechones = numLechones;
    }

    public String getNumCrecimiento() {
        return numCrecimiento;
    }

    public void setNumCrecimiento(String numCrecimiento) {
        this.numCrecimiento = numCrecimiento;
    }

    public String getNumFinalizacion() {
        return numFinalizacion;
    }

    public void setNumFinalizacion(String numFinalizacion) {
        this.numFinalizacion = numFinalizacion;
    }

    public String getNumSementales() {
        return numSementales;
    }

    public void setNumSementales(String numSementales) {
        this.numSementales = numSementales;
    }
