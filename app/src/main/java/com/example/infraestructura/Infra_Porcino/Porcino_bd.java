...
public class Porcino_bd {

    public static final String TABLA_BD                 = "TB_PORCINO";
    ...
    public static final String COLUMN_NUMVIENTRES       = "NUMVIENTRES";
    public static final String COLUMN_NUMLECHONES       = "NUMLECHONES";
    public static final String COLUMN_NUMCRECIMIENTO    = "NUMCRECIMIENTO";
    public static final String COLUMN_NUMFINALIZACION   = "NUMFINALIZACION";
    public static final String COLUMN_NUMSEMENTALES     = "NUMSEMENTALES";
    ...
    public static final String CREAR_TABLA_PORCINO= "CREATE TABLE " + TABLA_BD + "("
            ...
            + COLUMN_NUMVIENTRES + " VARCHAR, "
            + COLUMN_NUMLECHONES + " VARCHAR, "
            + COLUMN_NUMCRECIMIENTO + " VARCHAR, "
            + COLUMN_NUMFINALIZACION + " VARCHAR, "
            + COLUMN_NUMSEMENTALES + " VARCHAR, "
